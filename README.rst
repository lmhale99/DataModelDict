...
**class DataModelDict.DataModelDict(*args, **kwargs)**
   ...
   **append(key: str, value: Any, before: str | None = None, after:
   str | None = None)**
   ...
   **find(key: str, yes: dict = {}, no: dict = {}) -> Any**
   ...
   **finds(key: str, yes: dict = {}, no: dict = {}) -> list**
   ...
   **iteraslist(key: str) -> Generator[Any, None, None]**
   ...
   **iterfinds(key: str, yes: dict = {}, no: dict = {}) ->
   ...
   **iterpaths(key: str, yes: dict = {}, no: dict = {}) ->
   ...
   **json(fp: IOBase | None = None, *args, **kwargs) -> str | None**
   ...
   **load(model: str | bytes | Path | IOBase, format: str | None =
   None)**
   ...
   **move(key: str, index: int | None = None, before: str | None =
   None, after: str | None = None)**

      Moves a key in the dict to a specified position. All other keys
      will retain their relative orders.
   ...
   **path(key: str, yes: dict = {}, no: dict = {}) -> list**
   ...
   **paths(key: str, yes: dict = {}, no: dict = {}) -> list**
   ...
   **reorder(keys: list)**
      ...
      :Parameters:
         **keys** (*list*) – The dict keys in the order you want them
         reordered to.  Any keys in the dict not listed will be moved
         to the end.

   **xml(fp: IOBase | None = None, indent: int | str | None = None,
   **kwargs) -> str | None**
...
**DataModelDict.uber_open_rmode(data: str | bytes | Path | IOBase) ->
